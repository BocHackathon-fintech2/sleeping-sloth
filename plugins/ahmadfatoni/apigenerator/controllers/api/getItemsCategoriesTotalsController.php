...
class getItemsCategoriesTotalsController extends Controller
{
    ...
    public function index(Request $request){
       ...
       return Db::select('select * from sleepingsloth_posdata_receipts AS receipts INNER JOIN sleepingsloth_posdata_receipts_items AS items ON items.receipts_id = receipts.id WHERE receipts.customer_id="'.$id.'" ');
       //return Db::select('select * from sleepingsloth_posdata_receipts_items WHERE receipts_id="'.$id.'" ');
